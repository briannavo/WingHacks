...
const TipsPage = () => {
  return (
    <div>
      <h1 style={{color: 'green', textAlign:'center'}}>Domestic Violence Safety Tips</h1>
      <ul style={{ listStyleType: 'circle', textAlign:'center'}}>
    ...
    <h1 style={{color: 'green', textAlign:'center'}}>Steps to Leave Abusive Situation</h1>
      <ul style={{ listStyleType: 'circle', textAlign:'center'}}>
        <li> Make a plan</li>
      ...
      <h1 style={{color: 'green', textAlign:'center'}}>Steps to Take after Leaving Abusive Situation</h1>
      <ul style={{ listStyleType: 'circle', textAlign:'center'}}>
